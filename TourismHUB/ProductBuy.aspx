<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductBuy.aspx.cs" Inherits="TourismHUB_Product" %>
...
<body alink="#ffffcc"><br />
 <h1 align="center" 
    ...
    <div class="card" align="left" 
        ...
        style="height: 937px; width: 709px; line-height: 35px; font-size: -11px; color: #000000; font-weight: normal;">
    
        <h4 style="color: #3366FF; font-size: 28px; font-style: normal;">Product Selling 
            Form.:</h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        ...
        <br />
        <asp:TextBox ID="TextBox8" placeholder="  Another one mobile no " 
            runat="server" Height="32px" Width="623px" TextMode="Phone"></asp:TextBox>
        <br />
        <br />
        Available Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
            ErrorMessage="⚠️Please Fill Address." ControlToValidate="TextBox9"></asp:RequiredFieldValidator>
        <br />
        <asp:TextBox ID="TextBox9" placeholder=" Street Address " runat="server" Height="32px" Width="623px"></asp:TextBox>
        <br />
        <asp:TextBox ID="TextBox10" placeholder=" City" runat="server" Width="301px" Height="32px"></asp:TextBox>
&nbsp;&nbsp;
        <asp:TextBox ID="TextBox11" placeholder=" Postal / Zip Code " runat="server" Width="301px" Height="32px"></asp:TextBox>
        <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
            ErrorMessage="⚠️Please Fill Your City" ControlToValidate="TextBox10"></asp:RequiredFieldValidator>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
            ErrorMessage="⚠️Please Fill zip code" ControlToValidate="TextBox11"></asp:RequiredFieldValidator>
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button  ID="Button1" runat="server" Text="Place Your Order" Height="41px" Width="214px" BackColor="#0066FF" BorderColor="White" Font-Bold="True" CssClass="button" ForeColor="White"  ClientIDMode="Inherit" EnableViewState="True" onclick="Button1_Click"  />
&nbsp;<br />
        <br />
